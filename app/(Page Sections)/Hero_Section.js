...
const HeroSection = () => {
  return (
    <div id='herosection' className="flex gap-3 flex-col justify-center px-2 sm:px-10 lg:px-20 bg-cover bg-fixed bg-[url('https://bootstrapmade.com/demo/templates/Medilab/assets/img/hero-bg.jpg')] h-[calc(70vh)] w-full">
